...
public class MenuItemController {
	...
	public String editMenuItem(@ModelAttribute("menuItemBean") @Valid MenuItem menuItem, BindingResult bindingResult, ModelMap model) {
		log.info("Start");
	...
	public String addMenuItem(@ModelAttribute("menuItemBean") @Valid MenuItem menuItem, BindingResult bindingResult, ModelMap model) {
